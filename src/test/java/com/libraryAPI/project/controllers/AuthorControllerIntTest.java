...
//DirtiesContext cleans between each method
...
//        this.authorService = author;
    ...
    public void testCreateAuthor() throws Exception {
        AuthorEntity testAuth = TestDataUtil.createTestAuthorA();
        testAuth.setId(null); //as auto generates
        String authorinJson = map.writeValueAsString(testAuth); //make it to json
    ...
    @Test
    public void testSavedAuthorReturned() throws Exception {
        AuthorEntity testAuth = TestDataUtil.createTestAuthorA();
        testAuth.setId(null); //as auto generates
        String authorinJson = map.writeValueAsString(testAuth); //make it to json
        //Requestbuilder post to where we map it
